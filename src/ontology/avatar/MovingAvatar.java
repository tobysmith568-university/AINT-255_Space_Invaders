...
public class MovingAvatar extends VGDLSprite {
    ...
    /**
     * Disqualified flag, moved from Game class to individual players, as there
     * may be more than 1 in a game; variable still in Game class for single
     * player games to keep back-compatibility
     */

...
public class Agent extends AbstractPlayer {
    ...
    public Types.ACTIONS act(StateObservation stateObs, ElapsedCpuTimer elapsedTimer) {
        ...
        ArrayList<Types.ACTIONS> debugActions = stateObs.getAvailableActions();

        System.out.println(Arrays.toString(debugActions.toArray()));
...
//        printDebug(portalPositions,"por");
    ...
    /**
     * Prints the number of different types of sprites available in the
     * "positions" array. Between brackets, the number of observations of each
     * type.
     *

...
public class LearningMachine {
    ...
    /**
     * Reads and launches a game for an agent to be played. Graphics can be on
     * or off.
     *
     ...
     * @param cmd array with name of the script file to run for the client, plus
     * agent and port
...
//
    ...
    /**
     * Reads and launches a game to be played on a series of both pre-determined
     * and non pre-determined levels.
     *
     * @param game_file game description file.
     * @param level_files file with the level to be played.
     * @param cmd array with name of the script file to run for the client, plus
     * agent and port
     * @param actionFiles filename of the file where the actions of this player,
     * for this game, should be recorded.
     */
...
//                vict + " , " + sc);
    ...
    /**
     * Method used to play a single given level. It is also used to request
     * player input in regards to the next game to be played.
     *
     ...
     * has been played in a row. Is also sent from the exterior, and exists for
     * debugging only.
     ...
     * @param scores Array of scores to be modified. Is modified at the end of
     * the level.
...
//        System.out.println("LearningMachine required level="+level);
     ...
     * @return the player, created but NOT initialized, ready to start playing
     * the game.
     */
    ...
    /**
     * Tears multiple players down. This initiates the saving of actions to
     * file. It should be called when the game played is over. Not useful for
     * singleLearning
     *

...
/**
 * Created by IntelliJ IDEA. User: sml Date: 07-Aug-2004 Time: 08:36:49 To
 * change this template use File | Settings | File Templates. This class
 * contains static functions that are common to both SimpleWriter and
 * SimpleReader
 */
public class Util implements Serial {
     ...
     */
    private static final ReflectionFactory reflFactory = (ReflectionFactory) AccessController.doPrivileged(
